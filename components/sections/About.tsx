    ...
    <section className="py-24">
      <Container>
        <div className="grid gap-16 lg:grid-cols-[1.2fr_0.8fr] items-center">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {about.features.map((feature) => (
                <div key={feature.title} className="rounded-3xl border border-slate-200 bg-slate-50 p-6">
                  <p className="text-sm font-semibold uppercase tracking-[0.24em] text-emerald-600">{feature.title}</p>
          ...
          <div className="rounded-[2rem] bg-emerald-50 p-10 shadow-sm">
            <div className="rounded-3xl border border-emerald-100 bg-white p-8 shadow-sm">
              <p className="text-sm uppercase tracking-[0.3em] text-emerald-600">Why clients choose us</p>
